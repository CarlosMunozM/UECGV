 ...
 * @author Carlos
 */
@WebServlet(name = "srvCanton", urlPatterns = {"/srvCanton"})
public class srvCanton extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            switch (accion) {
                case "mostrar_cantones":
                    try {
                        cantonDAO = new CantonDAO();

                        listaCantones = cantonDAO.mostrarCantones();
                        response.getWriter().write(new Gson().toJson(listaCantones));
