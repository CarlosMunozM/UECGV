...
<html>
    <head>
        ...
        <meta charset="utf-8" />
        <title>Cuentas de Usuarios - U.E.M Carmelina Granja Villanueva</title>
            ...
            <!-- <div id="sidebar" class="sidebar h-sidebar navbar-collapse  ace-save-state"> -->
                ...
                <div class="sidebar-shortcuts" id="sidebar-shortcuts">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="<%=request.getContextPath()%>/srvUsuario?accion=mostrar_cuentas_usuarios">Cuentas de Usuarios</a>
                        </li>
                ...
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <a href="#" data-toggle="tooltip" title="Actualizar Tabla">
                            <button  onclick=" location.href = '/UECGV/srvUsuario?accion=mostrar_cuentas_usuarios'" class="btn btn-primary fa fa-refresh" style="float: left"> Actualizar</button>
                        </a>
                        <a href="#" data-toggle="tooltip" title="Registrar Cuentas de Usuarios">
                            <button  onclick=" location.href = '/UECGV/srvUsuario?accion=mostrar_empleados_sin_usuario'" class="btn btn-success fa fa-plus" style="float: right"> Registrar</button>
                        </a>
                        <center>
                            <h3><b>Cuentas de Usuarios</b></h3><br>
                        </center>
                        ...
                        <div class="row" >
                            ...
                            <table id="bootstrap-data-table"  class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach var="Users" items="${listaCuentasUsuarios}">
                                        <tr>
                                            <td>${Users.usuario}</td>
                                            <td>${Users.empleado.apellidos} ${Users.empleado.nombres}</td>
                                            <td>${Users.empleado.identificacion}</td>
                                            <td style="text-align: center;">
                                                <a href="#" data-toggle="tooltip" title="Recuperar Clave">
                                                    <button class="btn btn-sm btn-warning" id="btnRecuperarClaveAdmin"  
                                                            onclick="confirmarRecuperarCuentaUsuario(${Users.id_usuario}, '${Users.usuario}', '${Users.empleado.correo_institucional}');">
                                                        <i class="zmdi zmdi-mail-send"></i></button>
                                                </a>

                                                <a href="#" data-toggle="tooltip" title="Modificar Usuario">
                                                    <button class="btn btn-sm btn-success" id="btnModificarModAdmin" data-toggle="modal" data-target="#modalModificarCuentaUsuario" 
                                                            onclick="datosModalModificar('${Users.id_usuario}', '${Users.usuario}')">
                                                        <i class="zmdi zmdi-edit"></i></button>
                                                </a>
                                                <a href="#" data-toggle="tooltip" title="Eliminar Usuario">
                                                    <button class="btn btn-sm btn-danger" id="btnEliminarModAdmin" onclick="confirmarEliminacionCuentaUsuario(${Users.id_usuario});"> <i class="zmdi zmdi-delete" ></i></button>
                                                </a>
                                            </td>
                                        </tr>
                                    </c:forEach>
