                        ...
                        <form autocomplete="on"  enctype="multipart/form-data" id="formRegistrarAlu">
                            ...
                            <div class="row" style="margin-left: 4%">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input type="text" id="regDireccionAlu" style="text-transform:uppercase"  class="form-control" onkeypress="return soloLetrasNumerosCaracEspe(event)" maxlength="50"  name="txtRegDireccion" placeholder="Dirección">
                                    <%--pattern="[A-Za-z0-9ñ]+"--%>
                                </div>
                            ...
                            <div class="row" style="margin-left: 4%">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <input type="text" id="regCrntDiscAlu" class="form-control" onkeypress="return soloLetrasNumerosv2(event)" maxlength="20"  name="txtRegCarnet" placeholder="Código">
                                </div>
                                <div class="col-sm-2">
                            ...
                            <div class="row" style="margin-left: 4%">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input type="text" id="regOcupacionRepP" style="text-transform:uppercase"  class="form-control"   name="txtRegFamiliarOcupacionPadre" placeholder="Ocupación">
                                </div>
                            ...
                            <div class="row" style="margin-left: 4%">
                                ...
                                <div class="col-sm-3">
                                    <label>Ocupación</label>
                                    <input type="text" id="regOcupacionRep" style="text-transform:uppercase"  class="form-control"    name="txtRegFamiliarOcupacionMadre" placeholder="Ocupación">
                                </div>
