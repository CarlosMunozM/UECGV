...
function datosModalMostrarALU(tipoIdentificacion, identificacionEst, nacionalidadEst, genero, nombres, apellidos, fecha_nacimiento, nombre_curso,tipo_de_curso, direccion, numero_hermanos, lugar_ocupa,
...
{
    console.log(foto);
    console.log(fotoDomicilio);
    $('#modAluTipoIdentificacion').html(tipoIdentificacion);
    $('#modVerAludentificacion').html(identificacionEst);
    $('#modVerAluPais').html(nacionalidadEst);
    if (genero === 'M')
...
//function enviaridentificacion(identificacion){
//   /* $("#modalModificarEstDatos").ready(function(){
//        setTimeout(function(){$('#regidentificacionAlu').val(identificacion);},1000);
//    });
//    alert(identificacion);*/
//    var display = $("#modalModificarEstDatos").css("display");
//    setTimeout(function(){
//        var display = $("#modalModificarEstDatos").css("display");
//        alert(display);
//        $('#regidentificacionAlu').val(identificacion);
//    },2000);
//}

function enviaridentificacion(identificacion){
    window.location.href = '/UECGV/srvEstudiante?accion=mostrar_estudiante_identificacion&Identificacion=' + identificacion + '';
}
