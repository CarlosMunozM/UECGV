...
<html>
    <head>
        ...
        <link href="/Administracion/css/material-design-iconic-font.min.css" rel="stylesheet" type="text/css"/>
    ...
    <body class="no-skin">
            ...
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                ...
                <div class="sidebar-shortcuts" id="sidebar-shortcuts">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="../srvUsuarios?accion=mostrar">Alumnos</a>
                        </li>
                ...
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <a href="#" data-toggle="tooltip" title="Actualizar Tabla">
                            <button  onclick=" location.href = '../srvUsuarios?accion=mostrar'" class="btn btn-primary fa fa-refresh" style="float: left"> Actualizar</button>
                        </a>
                        <a href="#" data-toggle="tooltip" title="Registrar Usuario">
                            <button  onclick=" location.href = '../srvUsuarios?accion=countries'" class="btn btn-success fa fa-user" style="float: right"> Registrar</button>
                        </a>
                        <center>
                        ...
                        <div class="row">
                            ...
                            <table id="bootstrap-data-table"  class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach var="Users" items="${listaPersonas}">
                                        <tr>
                                            <td>${Users.persona.apellidos} ${Users.persona.nombres}</td>
                                            <td>${Users.persona.telefono}</td>
                                            <td>${Users.persona.tipopersona.nombretipo}</td>
                                            <td style="text-align: center;">
                                                <a href="#" data-toggle="tooltip" title="Ver Datos">
                                                    <button class="btn btn-sm btn-info" id="btnMostrarDatos" data-toggle="modal" data-target="#modalDatos" 
                                                            onclick="datosModalMostrar('${Users.persona.tipoidentificacion}', '${Users.persona.identificacion}', '${Users.persona.pais.nombre}', '${Users.persona.genero}', '${Users.persona.nombres}', '${Users.persona.apellidos}', '${Users.persona.tipopersona.nombretipo}', '${Users.persona.email}', '${Users.persona.telefono}', '${Users.usuario}', '${Users.persona.direccion}')">
                                                ...
                                                <a href="#" data-toggle="tooltip" title="Modificar">
                                                    <button class="btn btn-sm btn-success" id="btnMostrarModificarMod" data-toggle="modal" data-target="#modalModificarDatos" 
                                                            onclick="datosModalModificar(${Users.persona.id_persona}, '${Users.persona.tipoidentificacion}', '${Users.persona.identificacion}', '${Users.persona.pais.idPais}', '${Users.persona.genero}', '${Users.persona.nombres}', '${Users.persona.apellidos}', ${Users.persona.tipopersona.id_tipo}, '${Users.persona.email}', '${Users.persona.telefono}', '${Users.usuario}', '${Users.persona.direccion}')">
                                                        <i class="zmdi zmdi-edit"></i></button>
                                                </a>
                                                <a href="#" data-toggle="tooltip" title="Eliminar">
                                                    <button class="btn btn-sm btn-danger" onclick="confirmarEliminacion(${Users.persona.id_persona});"> <i class="zmdi zmdi-delete" ></i></button>
                                                </a>
                                            </td>
                                        </tr>
                                    </c:forEach>
        ...
        <![endif]-->
            ...
            <script src="/UECGV/plugins/dataTable/jquery.dataTables.min.js" type="text/javascript"></script>
            <link href="/UECGV/plugins/dataTable/jquery.dataTables.min.css" rel="stylesheet" type="text/css"/>
